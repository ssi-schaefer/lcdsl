...
public class LcDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class TestConfigElements extends AbstractParserRuleElementFinder {
		...
		//TestConfig:
		//	{TestConfig} 'test' BLOCK_BEGIN (('runner' runner=TestRunnerType ';')?
		//	& ('container' container=STRING ';')?
		//	& ('class' class=FQName ';')?
		//	& ('method' method=STRING ';')?
		//	& ('exclude-tags' excludeTags=Tags ';')?
		//	& ('include-tags' includeTags=Tags ';')?) BLOCK_END;
		@Override public ParserRule getRule() { return rule; }
		
		//{TestConfig} 'test' BLOCK_BEGIN (('runner' runner=TestRunnerType ';')? & ('container' container=STRING ';')? & ('class'
		//class=FQName ';')? & ('method' method=STRING ';')? & ('exclude-tags' excludeTags=Tags ';')? & ('include-tags'
		//includeTags=Tags ';')?) BLOCK_END
		public Group getGroup() { return cGroup; }
		...
		//(('runner' runner=TestRunnerType ';')? & ('container' container=STRING ';')? & ('class' class=FQName ';')? & ('method'
		//method=STRING ';')? & ('exclude-tags' excludeTags=Tags ';')? & ('include-tags' includeTags=Tags ';')?)
	...
	public class TestRunnerTypeElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final EnumLiteralDeclaration cJUNIT4EnumLiteralDeclaration_0 = (EnumLiteralDeclaration)cAlternatives.eContents().get(0);
		private final Keyword cJUNIT4Junit4Keyword_0_0 = (Keyword)cJUNIT4EnumLiteralDeclaration_0.eContents().get(0);
		private final EnumLiteralDeclaration cJUNIT5EnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cJUNIT5Junit5Keyword_1_0 = (Keyword)cJUNIT5EnumLiteralDeclaration_1.eContents().get(0);
		...
		//enum TestRunnerType:
		//	JUNIT4="junit4" | JUNIT5="junit5" | JUNIT3="junit3";
		public EnumRule getRule() { return rule; }
		...
		//JUNIT4="junit4"
		public EnumLiteralDeclaration getJUNIT4EnumLiteralDeclaration_0() { return cJUNIT4EnumLiteralDeclaration_0; }
		
		//"junit4"
		public Keyword getJUNIT4Junit4Keyword_0_0() { return cJUNIT4Junit4Keyword_0_0; }
		
		//JUNIT5="junit5"
		public EnumLiteralDeclaration getJUNIT5EnumLiteralDeclaration_1() { return cJUNIT5EnumLiteralDeclaration_1; }
		
		//"junit5"
		public Keyword getJUNIT5Junit5Keyword_1_0() { return cJUNIT5Junit5Keyword_1_0; }
